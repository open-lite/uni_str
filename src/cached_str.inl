...
namespace ol {
	...
	template<typename... Encs>
	template<class TargetEnc> OL_CPP20_CONSTEXPR 
...
namespace ol {
	template<typename... Encs> OL_CPP20_CONSTEXPR 
...
namespace ol {
	...
	template<typename... Encs>
	template<typename Enc> OL_CPP14_CONSTEXPR 
	...
	get_internal_str() const noexcept -> typename std::enable_if<contains<Enc>::value,
		...
		return   ol::get<uni_string<Enc>>(strings);
	}
